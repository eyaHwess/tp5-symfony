...
class UtilisateurControllerTest extends WebTestCase
{
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'utilisateur[groupes]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getGroupes());
    }
